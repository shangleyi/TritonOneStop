                    ...
                    <TableBody>
                        {rows.map(row => (
                            <TableRow key={row.name}>
                                <TableCell className={useStyles.sticky} omponent="th" scope="row">
                                    {row.name}
                                </TableCell>
                                <TableCell className={useStyles.sticky} align="right">{row.credits}</TableCell>
                                <TableCell className={useStyles.sticky} align="right">{row.hours}</TableCell>
                                <TableCell className={useStyles.sticky} align="right">{row.grade}</TableCell>
                                <TableCell className={useStyles.sticky} align="right">{row.gpa}</TableCell>
                            </TableRow>
                        ))}
                    </TableBody>
                </Table>
